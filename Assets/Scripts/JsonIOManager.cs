...
/*
//save
JsonExporter.CreateJsonFile(Application.dataPath, "ClassType", new ClassType(true));

//load
var instance = JsonImporter.LoadJsonFile<ClassType>(Application.dataPath, "ClassType");
*/
...
public static class JsonImporter
{
    ...
    {
        Debug.Log(string.Format("Load: JsonFile From {0}/{1}", loadPath, fileName));
...
public static class JsonExporter
{
    ...
    {
        Debug.Log(string.Format("Create: JsonFile To {0}/{1}", createPath, fileName));
